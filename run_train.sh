...
python3 main.py --data.num_workers=12 --data.in_memory=1 \
    ...
    --adv.attack apgd --adv.n_iter 2 --adv.norm Linf --training.distributed 1 --training.batch_size 80 --lr.lr 1e-3 --logging.save_freq 2  \
    ...
    --dist.world_size '# of GPUS' --training.distributed 1 --model.pretrained 0 --model.arch vit_b --training.epochs 300 \
